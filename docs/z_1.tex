...
\citep{R-bookdown} \textbf{knitr} \citep{xie2015}.

Sea la \textbf{función} de segundo grado \(ax^2+bx+c=y\) entonces las raices de esta ecuación se obtiene al despejar la ecuación \(ax^2+bx+c=0\)
\begin{align*}
ax^2+bx+c&=0\\
